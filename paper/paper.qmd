...
The remainder of the paper is structured as follows: @sec-data details the data and measurement process. @sec-Methodology describes the methodology, including linear and Bayesian models. @sec-Results presents the results, highlighting trends in polling, and @sec-Discussion discusses the implications of the findings for future election forecasting and research.
...
#| message: false
#| label: fig-figure1
#| fig-cap: "illustrates a simple linear regression between end date and pct, showing a positive trend with a noticeable dip in the middle."
#| fig_caption: true
#| echo: false
...
base_plot +
  geom_point() +
  geom_smooth()+
  labs(title = "Election Trends: Regression of End Date and Respondents of Vote")
```
...
#| message: false
#| label: fig-figure2
#| fig-cap: "Shows a linear regression applied to multiple subsets of the data using facet wrap. Each panel represents a different pollster, with regression lines indicating a generally consistent positive trend, despite some dips."
#| fig_caption: true
#| echo: false
...
base_plot +
  ...
  labs(title = "Election Trends: Linear Regression Across Pollster Subsets")
```
...
#| message: false
#| label: fig-figure3
#| fig-cap: "uses facet wrap to show linear regression across various states. Each panel reveals a linear relationship, with clearer trends in panels with more data points."
#| fig_caption: true
#| echo: false
...
base_plot +
  ...
  labs(title = "Election Trends: Linear Regression Across States")
```
...
#| message: false
#| label: fig-figure4
#| fig-cap: "illustrates a Bayesian model showing a moderate upward trend, where percentage increases with end date."
#| fig_caption: true
#| echo: false
...
#| message: false
#| label: fig-figure5
#| fig-cap: "presents a Bayesian model with color-coded points for different states."
#| fig_caption: true
#| echo: false
